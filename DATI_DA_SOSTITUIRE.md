...
| 10 | `legal/termini-di-servizio.html` | 183 | Preambolo dei termini: chi offre il servizio | `[[NOME E COGNOME DEL TITOLARE]]` | Il nome e il cognome della persona fisica che risponde del progetto. Esempio: `Mario Rossi`. |
| 11 | `legal/termini-di-servizio.html` | 183 | Preambolo dei termini: chi offre il servizio | `[[INDIRIZZO COMPLETO — via e numero civico, CAP]]` | Via, numero civico e CAP dell'indirizzo a cui si possono mandare comunicazioni formali. La città (Torino, Italia) è già scritta accanto e non va ripetuta. Esempio: `Via Roma 1, 10121`. |
| 12 | `legal/termini-di-servizio.html` | 183 | Preambolo dei termini: chi offre il servizio | `[[P.IVA O CODICE FISCALE — oggi IT01234567890, valore di prova]]` | La partita IVA vera, se c'è; altrimenti il codice fiscale della persona fisica. `IT01234567890` è un numero di prova: non esiste e non va lasciato. |
